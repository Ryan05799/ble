...
#define MAX_CONN_INTERVAL               24                                          /**< Maximum acceptable connection interval (7.5 ms), Connection interval uses 1.25 ms units. */
...
typedef struct ble_init_s
{
	...
	ble_mps_t												m_ble_mps;																	
	ble_bas_t												m_ble_bas;
	app_timer_id_t									m_clock_timer_id;														/**< Timer for clock*/
	ble_mps_write_handler_t       	command_handler;
	ble_mps_write_handler_t       	timer_handler;
}	ble_init_t;
